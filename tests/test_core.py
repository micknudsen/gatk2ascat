...
class TestSegmentation(unittest.TestCase):
    ...
    def test_create_segmentation(self):
        segmentation = Segmentation(segments=[self.segment_1a, self.segment_1b, self.segment_2a])
        self.assertEqual(segmentation._segments['chr1'], [self.segment_1a, self.segment_1b])
        self.assertEqual(segmentation._segments['chr2'], [self.segment_2a])
